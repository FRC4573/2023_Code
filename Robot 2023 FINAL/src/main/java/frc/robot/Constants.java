...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double ksVolts = 0.98845;
    public static final double kvVoltSecondsPerMeter = 0.66302;
    public static final double kaVoltSecondsSquaredPerMeter = 0.41444;

    // Example value only - as above, this must be tuned for your drive!
    public static final double kPDriveVel = 1.0991;
  }
